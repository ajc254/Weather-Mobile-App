...
public class Forecast1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        day = view.findViewById(R.id.forecast_1_day);
        DAY_OF_WEEK = null;
        weatherIcon = view.findViewById(R.id.forecast_1_icon);
        temperatureField = view.findViewById(R.id.forecast_1_temp);
    ...
    public void populateWeatherData() {
        ...
        // Query database.
        Cursor result = dbCommands.getForecastWeather(getActivity().getApplicationContext(), 1);
