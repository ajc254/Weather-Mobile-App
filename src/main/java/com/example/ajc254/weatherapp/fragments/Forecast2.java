...
public class Forecast2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        day = view.findViewById(R.id.forecast_2_day);
        weatherIcon = view.findViewById(R.id.forecast_2_icon);
        temperatureField = view.findViewById(R.id.forecast_2_temp);
    ...
    public void populateWeatherData() {
        ...
        // Query database.
        Cursor result = dbCommands.getForecastWeather(getActivity().getApplicationContext(), 2);
